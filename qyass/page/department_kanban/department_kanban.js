frappe.pages['department-kanban'].on_page_load = function(wrapper) {
	var page = frappe.ui.make_app_page({
		...
		wrapper.elements_page_filter = new DepartmentKanban(wrapper);
